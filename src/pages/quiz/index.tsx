...
const Quiz: NextPage = () => {
  ...
  return (
    <div className="w-screen h-screen bg-neutral-200 flex justify-center flex-col items-center space-y-5">
        ...
        <div key={q.id} className="card bg-base-100 shadow-xl">
          <div className="card-body">
            <h2 className="card-title flex justify-between">
              {q.title}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 cursor-pointer" onClick={() => { handleDeleteQuiz(q.id).catch((e) => console.error(e)) }}>
      ...
      <button className="btn btn-secondary" onClick={() => { handleCreateQuiz().catch((e) => { console.error(e) }) }}>
