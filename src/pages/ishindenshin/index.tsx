...
const Ishindenshin: NextPage = () => {
  ...
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center space-y-5 bg-neutral-200 overflow-y-scroll">
      <button
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                ...
                <button
                  ...
                  onClick={() => {
                    handleResetSession(session.id).catch((e) =>
                      console.error(e)
                    )
                  }}
                >
