  ...
  return (
    <div className="w-screen h-screen bg-neutral-200 flex justify-center items-center space-x-10">
      {groomAnswer.data?.boardImageUrl && brideAnswer.data?.boardImageUrl && state === 'SHOW' ?
        <Fragment>
          {/* NOTE: heightが特に意味ない */}
          <Image className="bg-white" src={groomAnswer.data.boardImageUrl} alt="groom answer" width={width / 3} height={0} />
          <Image className="bg-white" src={brideAnswer.data.boardImageUrl} alt="bride answer" width={width / 3} height={0} />
        </Fragment>
